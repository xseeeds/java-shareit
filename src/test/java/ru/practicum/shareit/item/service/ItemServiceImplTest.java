...
class ItemServiceImplTest {
    ...
    void setUp() {
        ...
        itemShortResponseDtoProjection = new ItemShortResponseDtoProjection() {
            ...
            public String getDescription() {
                return itemResponseDto.getDescription();
            }

            @Override
            public Boolean getAvailable() {
                return itemResponseDto.getAvailable();
            }

            @Override
            public Long getRequestId() {
                return itemResponseDto.getRequestId();
            }
    ...
    void createItemWhenOwnerIsExistsThenItemResponseDtoReturnTest() {
        ...
        final ItemResponseDto createdItemResponseDto = itemService.createItem(2L, itemResponseDto);

        assertThat(createdItemResponseDto.getName(), equalTo(itemResponseDto.getName()));
        //assertThat(itemEntity.getOwner(), equalTo(ownerEntity));
    ...
    void updateItemWhenUserIsOwnerThenItemResponseDtoReturnTest() {
        final ItemResponseDto updatedItemResponseDto = itemResponseDto
                .toBuilder()
                .name("Item Update")
