...
class UserServiceImplTest {
    ...
    void createUserWhenUserIsCorrectThenUserAdded() {
        ...
        final UserResponseDto addedUser = userService.createUser(userRequestDto);
    ...
    void updateUserWhenUserIsCorrectThenUserResponseDtoReturnTest() {
        ...
        final UserResponseDto updatedUser = userService.updateUser(1L, userRequestDto);

        assertThat(updatedUser.getName(), equalTo(userRequestDto.getName()));
        assertThat(updatedUser.getEmail(), equalTo(userRequestDto.getEmail()));
