...
public class ErrorHandler {
    ...
    public ErrorResponse errorBadRequestException(
        ...
        log.warn("SERVER => " + e.getMessage(), e);
        return new ErrorResponse(BAD_REQUEST.toString(),
    ...
    public ErrorResponse errorNotFoundException(
        ...
        log.warn("SERVER => " + e.getMessage(), e);
        return new ErrorResponse(NOT_FOUND.toString(),
    ...
    public ErrorResponse errorConflictException(
        ...
        log.warn("SERVER => " + e.getMessage(), e);
        return new ErrorResponse(CONFLICT.toString(),
    ...
    public ErrorResponse errorDataIntegrityViolationException(
        ...
        log.warn("SERVER => " + e.getMostSpecificCause().getMessage(), e);
